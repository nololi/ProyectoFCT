...
<div class="container-fluid">
	...
	<div class="row margen5ciento">
		<?php				
				if(isset($_SESSION['email'])){
					//echo "<h2>ver sus contratos</h2>";
					//mostrarContratos();	

		?>
		<div class="col-xs-12">
			<a name="contenidoprincipal"></a>
			<h1 class="text-primary text-center">Panel de cliente</h1>
	...
	<div class="row margen5ciento">	
			...
			<div class="col-xs-10 col-xs-offset-1 col-md-3 col-md-offset-2">
					...
					<a href="administrar-su-usuario" target="_self">
						<img src="images/usuario.png" alt="administrar su usuario. Logo creado por flaticon" class="img-responsive"/>
						<p class="text-center">Administrar su usuario</p>
					</a>
			</div>
			<div class="col-xs-10 col-xs-offset-1 col-md-3">
					<a href="ver-sus-contratos" target="_self">
						<img src="images/contrato.png" alt="ver sus contratos.Logo creado por flaticon" class="img-responsive"/>
						<p class="text-center">Ver sus contratos</p>
					</a>
			</div>
		<?php
				}
